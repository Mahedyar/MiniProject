...
const cardsInfo = [];
cardsInfo.push(new Card('Avengers:Endgame', 'HyperText Markup Language', 'res/img/image.jpg'))
cardsInfo.push(new Card('Hobbs & ', 'Cascading Style Sheets', 'res/img/image.jpg'))
